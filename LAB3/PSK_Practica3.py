...
class PSK_Practica3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSK_Practica3")
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "Nº bit por simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._kf_range = Range(-2*math.pi, 2*math.pi, 0.001, math.pi/2, 200)
        self._kf_win = RangeWidget(self._kf_range, self.set_kf, "Coeficiente de sensibilidad frecuencia (MHz/V)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._No_win = RangeWidget(self._No_range, self.set_No, "Nivel de ruido", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel de continua", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._B_range = Range(1, 40, 1, 20, 200)
        self._B_win = RangeWidget(self._B_range, self.set_B, "Nº Muestras por simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, "Coeficiente d sensibilidad fase", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=PSK_Practica3, options=None):
