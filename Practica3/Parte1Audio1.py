...
class Parte1Audio1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Parte1Audio1")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 2.2e3, 1, 0, 0)
...
def main(top_block_cls=Parte1Audio1, options=None):
