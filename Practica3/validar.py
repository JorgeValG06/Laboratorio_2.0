...
# Title: Validacion Calculo Potencia
...
class validar(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Validacion Calculo Potencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Validacion Calculo Potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "validar")
        ...
        self._amp_win = RangeWidget(self._amp_range, self.set_amp, "Amplitud Señal", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, amp, 0, 0)
...
def main(top_block_cls=validar, options=None):
