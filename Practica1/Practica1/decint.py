...
# Title: Interpolacion y decimacion
...
class decint(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Interpolacion y decimacion", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Interpolacion y decimacion")
        ...
        self.settings = Qt.QSettings("GNU Radio", "decint")
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.rational_resampler_xxx_0_1, 0))
...
def main(top_block_cls=decint, options=None):
