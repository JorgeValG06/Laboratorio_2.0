...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 12500e3/8
        self.fm = fm = 20e3
        self.fc = fc = 50e6
        self.Kp = Kp = 1
        self.GTX = GTX = 1
        ...
        # Blocks
        ##################################################
        self._fm_range = Range(1e3, 20e3, 100, 20e3, 200)
        ...
        self.CalculoPotencia_0_0 = CalculoPotencia(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotencia_0_0)
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPM_0, 0), (self.blocks_complex_to_float_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.CalculoPotencia_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.CalculoPotencia_0_0, 0))
